...
Carefully designed to create authentic human connections
"""
...
class RelationshipAI:
    def __init__(self):
        ...
        # Sarah (Female) Persona Responses
        ...
        self.info_patterns = {
            "name": r"(?:my name is|i'm called|call me|i am|i'm)\s+([a-zA-Z]+)",
            "age": r"(?:i'm|i am|im)\s+(\d{1,2})\s*(?:years old|yo|y\.o)",
        ...
        self.gender_patterns = {
            "explicit_female": [
                r"i'm a (?:woman|girl|female|lady)",
                r"as a (?:woman|girl|female)",
                r"(?:woman|girl|female) here"
            ],
            "explicit_male": [
                r"i'm a (?:man|guy|male|dude|boy)",
                r"as a (?:man|guy|male)",
                r"(?:man|guy|male) here"
            ],
            "implicit_female": [
                r"my (?:boyfriend|husband|bf)",
                r"(?:he|him) and i",
                r"my man"
            ],
            "implicit_male": [
                r"my (?:girlfriend|wife|gf)",
                r"(?:she|her) and i",
                r"my (?:woman|girl)"
            ]
        }
    ...
    def detect_gender(self, message: str, user_id: str) -> Gender:
        """Detect user gender from message"""
