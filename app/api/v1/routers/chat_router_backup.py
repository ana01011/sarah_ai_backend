...
async def get_user_context(user_id: str) -> dict:
    """Get user context for personalization - FIXED VERSION WITH FACTS"""
    # Get user profile
    ...
    # GET ALL USER FACTS - THIS IS THE KEY FIX!
    ...
    # Get recent messages for context - FIXED QUERY
    ...
    # ADD ALL FACTS TO CONTEXT - THIS IS CRUCIAL!
    if facts:
        # Create facts dictionary
        context['facts'] = {}
        for fact in facts:
            context['facts'][fact['fact_type']] = fact['fact_value']
            # Also add to main context if not already there
...
async def send_message(
    ...
    try:
        ...
        # Store user message - FIXED: removed user_id from messages table
        ...
        # Store AI response - FIXED: removed user_id
        ai_message_id = uuid4()
        await db.execute("""
